...
class RecipeView(APIView):
    ...
    @swagger_auto_schema(
        ...
        responses={201: RecipeSerializer, 400: 'Validation error'}
    )
...
class RecipeDetailView(APIView):
    ...
    @swagger_auto_schema(
        operation_description="Retrieve a single recipe by ID.",
        responses={200: RecipeSerializer, 404: 'Recipe not found'},
        manual_parameters=[
            openapi.Parameter(
